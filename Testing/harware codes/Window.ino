...
// #define OM2M_NODE_ID_1 "AQ-BN00-00"
// #define OM2M_DATA_CONT_1 "AQ-BN00-00/Data"
// #define OM2M_DATA_LBL_1 "[\"AE-AQ\", \"V4.0.0\", \"AQ-BN00-00\", \"AQ-V4.0.0\"]"

#define CSE_IP "10.3.1.224"
#define OM2M_ORGIN "admin:admin"
#define CSE_PORT 5683
#define OM2M_AE "AE-TEST"
#define OM2M_NODE_ID "ACK-Window"
#define OM2M_DATA_CONT "ACK-Window/Data"
#define OM2M_DATA_LBL"[\"AE-TEST\", \"V4.0.0\", \"ACK-airpurifier\", \"AQ-V4.0.0\"]"


#define OM2M_NODE_ID_1 "ACK-Window"
#define OM2M_DATA_CONT_1 "ACK-Window/Latency"
...
void post_onem2m() {
    // time_4 = millis(); // Initialize time_4 before starting the HTTP request
    time_send = (time_3 - time_1) / 1000.0;
    int code = -1;
    while (code != 201) {
        // time_4 = millis(); // Continuously update time_4 until a 201 response is received
